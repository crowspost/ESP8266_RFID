...
#define enablePin  D1   // Connects to the RFID's ENABLE pin
#define rxPin      D2  // Serial input (connects to the RFID's SOUT pin)
#define txPin      D3  // Serial output (unused)
...
void setup()  // Set up code called once on start-up
{
  ...
  rfidSerial.begin(2400, SWSERIAL_8N1, rxPin, rxPin, false, 256);
